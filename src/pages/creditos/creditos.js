  ...
  return (
    <div className='creditos'>
      ...
      <div className='frameworks'>
        ...
        <ul>
          <li><b>Material-UI</b>, ajudou-me na criação de uma tabela mais <i>user friendly</i>, optei pelo uso desta framework no projeto
          ...
          <span className='tituloLink'>Link: </span><a className="link" href="mui.com/pt/" target="_blank">mui.com/pt/</a>
          
          <li><b>Rechart</b>, esta framework permitiu-me a criação de gráficos, não tinha conhecimento da mesma mas após uma breve pesquisa,
          pareceu-me a mais bonita e que mais se enquadra na aplicação.</li>
          <a href="mui.com/pt/" target="_blank">Por ver</a>

          <li><b>FontAwesome</b>, esta framework permitiu-me usar icons de forma mais simples.</li>
          <a href="mui.com/pt/" target="_blank">Por ver</a>
        </ul>
      </div>
    </div>
